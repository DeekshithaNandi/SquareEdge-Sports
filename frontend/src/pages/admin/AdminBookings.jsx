                      ...
                      <div className="flex gap-2 flex-wrap">
                        {b.status === 'CONFIRMED' && !label && (
                          <button onClick={() => openAssign(b)}
                            className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-[11px] font-bold bg-violet-500/10 border border-violet-500/25 text-violet-400 hover:bg-violet-500/20 transition-all">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-sm bg-[#1a1a30] border border-white/[0.12] rounded-2xl p-6 shadow-2xl">
            ...
            {assignTarget.bookingType !== 'BOX_CRICKET' ? (
              <>
                ...
                <input
                  ...
                  className={`w-full bg-white/[0.05] border rounded-xl px-4 py-3 text-sm text-white focus:outline-none mb-2 transition-all ${
                    assignConflict ? 'border-red-500/60 focus:border-red-500' : 'border-white/[0.1] focus:border-violet-500/50'
                  }`}
              ...
              <div className="bg-violet-500/[0.07] border border-violet-500/20 rounded-xl p-3.5 text-xs text-violet-300 mb-4">
