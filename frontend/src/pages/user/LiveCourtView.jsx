...
function typeColor(t) {
  ...
  if (t === 'BOX_CRICKET')  return { badge: 'bg-violet-500/15 text-violet-300 border-violet-500/25', dot: 'bg-violet-400' }
...
export default function LiveCourtView() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0b18] text-white">
      ...
      {/* Header */}
      <div className="sticky top-0 z-10 bg-[#0b0b18]/95 backdrop-blur-xl border-b border-white/[0.07] px-4 sm:px-6 py-4">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            { label: "Today's Total", val: bookings.length, icon: <Users size={16} />, color: 'text-violet-400', bg: 'bg-violet-500/10 border-violet-500/20' },
          ].map(s => (
          ...
          <>
            ...
            {active.length === 0 && upcoming.length === 0 && (
              <div className="text-center py-14 text-white/30">
                ...
                <Link to="/" className="mt-4 inline-flex items-center gap-1.5 text-xs text-violet-400 hover:text-violet-300">
                  Book a session ↗
                </Link>
              </div>
            )}
