              ...
              <div key={sport.key} className={`card p-4 border ${
                ...
                {!isMember ? (
                  <button
                    ...
                    className="w-full py-2 rounded-xl text-xs font-bold bg-gradient-to-r from-violet-600 to-indigo-600 hover:opacity-90 transition-all text-white flex items-center justify-center gap-1.5">
