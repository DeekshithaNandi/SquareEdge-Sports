...
export default function RegisterPage() {
  ...
  const bg = {background:'radial-gradient(ellipse at 25% 55%,#2a1060 0%,#1e1e35 55%),radial-gradient(ellipse at 80% 15%,#102050 0%,transparent 50%)'}
      ...
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-surface/90 backdrop-blur border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={sendOtp} className="space-y-4">
            ...
            <div><label className="text-xs font-bold text-muted uppercase tracking-wider block mb-1.5">Phone (optional)</label><input className="inp" type="tel" placeholder="+1 (555) 000-0000" value={form.phone} onChange={e=>set('phone',e.target.value)}/></div>
            <div>
