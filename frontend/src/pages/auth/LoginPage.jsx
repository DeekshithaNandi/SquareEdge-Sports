...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-5"
      style={{ background: 'radial-gradient(ellipse at 25% 55%,#2a1060 0%,#1e1e35 55%),radial-gradient(ellipse at 80% 15%,#102050 0%,transparent 50%)' }}>
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-surface/90 backdrop-blur border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Generic error (wrong password, deactivated, etc.) */}
